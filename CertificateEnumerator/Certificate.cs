...
namespace CertificateEnumerator
{
	public class Certificate
	{
		...
		public Certificate(X509Certificate2 cert)
		{
			...
			FriendlyName = _certificate.FriendlyName;// !string.IsNullOrWhiteSpace(_certificate.FriendlyName) ? _certificate.FriendlyName : string.Format("[{0}]\t[{1}]", _certificate.Issuer, _certificate.Subject);
